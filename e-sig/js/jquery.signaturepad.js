 ...
 */
 (function ($) {
    ...
    $.fn.signaturePad.defaults = {
      ...
      , penColour : '#0046c0' // Colour of the drawing ink
      ...
      , drawBezierCurves: true // Render smoother signatures using Bezier curves that pass through all the sampled points. Bezier curves are the new hot stuff, but lets let the default behavior be the original for now
